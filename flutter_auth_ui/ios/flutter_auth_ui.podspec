...
A new Flutter plugin.
  ...
  s.dependency 'FirebaseUI/Auth', '~> 12.3'
  s.dependency 'FirebaseUI/Anonymous', '~> 12.3'
  s.dependency 'FirebaseUI/Email', '~> 12.3'
  s.dependency 'FirebaseUI/Facebook', '~> 12.3'
  s.dependency 'FirebaseUI/Google', '~> 12.3'
  s.dependency 'FirebaseUI/OAuth', '~> 12.3'
  s.dependency 'FirebaseUI/Phone', '~> 12.3'
